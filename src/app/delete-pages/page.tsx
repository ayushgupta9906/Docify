...
export default function DeletePagesPage() {
    ...
    const handleProcess = async () => {
        ...
        try {
            ...
            const job = await api.processTool('delete-pages', fileIds, options);
        ...
        <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white dark:from-gray-900 dark:to-gray-800 py-12 px-4">
            <div className="max-w-4xl mx-auto">
                <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-12">
                    ...
                    <h1 className="text-4xl font-bold mb-4">Delete Pages</h1>
                    <p className="text-gray-600 dark:text-gray-400 text-lg">Remove unwanted pages from your PDF document</p>
                </motion.div>
                ...
                {processing && (
                    <div className="mt-8">
                        ...
                        {status === 'completed' && <div className="mt-6 text-center"><DownloadButton onClick={handleDownload} filename="edited.pdf" /></div>}
